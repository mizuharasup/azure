...
if game:GetService("CoreGui"):FindFirstChild("InfiniteHub") then
    game:GetService("CoreGui"):FindFirstChild("InfiniteHub"):Destroy()
end
...
function Update:Window(text,logo,keybind)
    ...
    local InfiniteHub = Instance.new("ScreenGui")
    InfiniteHub.Name = "Infinite Hub"
    InfiniteHub.Parent = game.CoreGui
    InfiniteHub.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

    local Main = Instance.new("Frame")
    Main.Name = "Main"
    Main.Parent = Infinite Hub
...
local Library = Update:Window("Winter hub BetaHub","",Enum.KeyCode.RightControl);
...
game.StarterGui:SetCore("SendNotification", {
      Icon = "rbxassetid://14601663040";
      Title = "#stay ganteng", 
      Text = "subscribe YT isnahamzah";
})
wait(3)
game.StarterGui:SetCore("SendNotification", {
      Icon = "rbxassetid://14601663040";
      Title = "isnahamzah", 
      Text = "discord.gg/isnahamzah";
})
end
...
loadingCompleteText.Text = "Subscribe Isnahamzah"
...
local function animateLoadingBar()
    ...
    while true do
        if Userid == 3362388567 or Userid == 3229297325 then
            ...
            wait(2) 
            gui:Destroy()
            intiInfniteHub() -- Letakkan loadstring di sini jika diperlukan
            WebhookScan()
