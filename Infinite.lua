...
local Title = "Infinite Group" .. (getgenv().Premium and " [Free]" or "")
local SubTitle = "True V2 discord.gg/baokhanh"
...
=
    ...
    ["Sea Events"] = {
       ...
       --[[ {
        ...
        {
            Mode = "Toggle",
            Title = "Auto Collect Infinite Wisp",
        ...
        {
            Mode = "Dropdown",
            Title = "Infinite Trade Min",
            Args = {"SeaEvents", "InfiniteEmberLimit"},
            Table = {15,20,25,30},
            Default = (function ()
                local Default = {15,20,25,30}
                local Found = 3
                if not table.find(Default,getgenv().Setting.SeaEvents.InfiniteEmberLimit) then 
                    getgenv().Setting.SeaEvents.InfiniteEmberLimit = 25
                else
                    Found = table.find(Default,getgenv().Setting.SeaEvents.InfiniteEmberLimit) 
                end
                return Found
            end)(),
            OnChange = function(value)
                getgenv().Setting.SeaEvents.InfiniteEmberLimit = tonumber(value)
                SettingManager:Save()
            end
        },
        {
            Mode = "Toggle",
            Title = "Auto Trade Infinite Wisp",
...
until getgenv().LoadUi and getgenv().IslandCaller and getgenv().SettingManager 
local Title = "Infinite Group" .. (getgenv().Premium and " [Free]" or "")
local SubTitle = "Test discord.gg/baokhanh"
local Fluent = loadstring(game:HttpGet("https://raw.githubusercontent.com/vinhuchi/rblx/main/FixedFluent.lua"))()
local UiSetting = Fluent.Options
local IslandCaller = IslandCaller or getgenv().IslandCaller
local SettingManager = getgenv().SettingManager 
